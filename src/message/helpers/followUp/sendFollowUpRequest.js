...
const sendFollowUp_1 = require("./sendFollowUp");
/**
 ...
 */
function sendFollowUpRequest(message, channelId, topic) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield (0, sendFollowUp_1.sendFollowUp)(message, channelId, topic);
        }
        catch (error) {
