...
class RateLimiter {
    ...
    canSendMessage(): boolean {
        const canSend = this.messagesLastHour.length < Number(process.env.LLM_MESSAGE_LIMIT_PER_HOUR) && this.messagesLastDay.length < Number(process.env.LLM_MESSAGE_LIMIT_PER_DAY);
