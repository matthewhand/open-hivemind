...
exports.adminRouter.post('/providers/:providerId/bots', middleware_1.requireAdmin, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var providerId, provider, e_3, message;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, res.json({ ok: true, message: "Created ".concat(provider.label, " bot") })];
            case 3:
                e_3 = _c.sent();
                message = (e_3 === null || e_3 === void 0 ? void 0 : e_3.message) || String(e_3);
                (0, audit_1.logAdminAction)(req, "CREATE_".concat(providerId.toUpperCase(), "_BOT"), "".concat(providerId, "-bots/").concat(((_b = req.body) === null || _b === void 0 ? void 0 : _b.name) || 'unknown'), 'failure', "Failed to create ".concat(provider.label, " bot: ").concat(message));
...
exports.adminRouter.post('/slack-bots', middleware_1.requireAdmin, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                e_4 = _c.sent();
                message = (e_4 === null || e_4 === void 0 ? void 0 : e_4.message) || String(e_4);
...
exports.adminRouter.post('/discord-bots', middleware_1.requireAdmin, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var provider, _a, name_1, token, llm, configDir, messengersPath, cfg, fileContent, e_5, e_6, DiscordModule, ds, instanceCfg, e_7, e_8, message;
    var _b, _c, _d;
        ...
        switch (_e.label) {
            ...
            case 4:
                ...
                if (e_5.code === 'ENOENT') {
                    ...
                    debug('Failed reading messengers.json', e_5);
                    throw e_5;
                }
                return [3 /*break*/, 5];
            case 5:
            ...
            case 9:
                e_6 = _e.sent();
                debug('Failed writing messengers.json', e_6);
                return [3 /*break*/, 10];
            case 10:
            ...
            case 12:
                e_7 = _e.sent();
                debug('Discord runtime add failed; config persisted:', e_7);
                return [3 /*break*/, 13];
            case 13:
            ...
            case 14:
                e_8 = _e.sent();
                message = (e_8 === null || e_8 === void 0 ? void 0 : e_8.message) || String(e_8);
...
exports.adminRouter.post('/reload', middleware_1.requireAdmin, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var configDir, messengersPath, cfg, content, e_9, addedSlack, addedDiscord, slack, existing, instances, _i, instances_1, inst, nm, slackAny, e_10, DiscordModule, ds, allBots, have, instances, _a, instances_2, inst, e_11, e_12, message;
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 16:
                e_11 = _h.sent();
                debug('Discord reload error', e_11);
                return [3 /*break*/, 17];
            case 17:
            ...
            case 18:
                e_12 = _h.sent();
                message = (e_12 === null || e_12 === void 0 ? void 0 : e_12.message) || String(e_12);
