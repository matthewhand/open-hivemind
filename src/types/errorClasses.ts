    ...
    switch (classification.type) {
      case 'network':
        return new NetworkError(
          ...
          (hivemindError as Record<string, unknown>).response as
            | { data?: unknown; headers?: Record<string, string>; status?: number }
            | undefined,
          (hivemindError as Record<string, unknown>).request as
      ...
      case 'authentication':
        return new AuthenticationError(
          ...
          (hivemindError as Record<string, unknown>).reason as
            | 'invalid_credentials'
            | 'expired_token'
            | 'missing_token'
            | 'invalid_format'
