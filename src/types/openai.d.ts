...
export type OpenAIResponse = OpenAIChatCompletionResponse | OpenAICompletionResponse | OpenAIModelsListResponse | OpenAIEmbeddingsResponse | OpenAIModerationResponse | OpenAIImageResponse | OpenAITranscriptionResponse | OpenAITranslationResponse | OpenAIFilesListResponse | OpenAIError;
export declare function isOpenAIError(response: OpenAIResponse): response is OpenAIError;
export declare function isChatCompletionResponse(response: OpenAIResponse): response is OpenAIChatCompletionResponse;
export declare function isModelsListResponse(response: OpenAIResponse): response is OpenAIModelsListResponse;
export declare function isCompletionResponse(response: OpenAIResponse): response is OpenAICompletionResponse;
