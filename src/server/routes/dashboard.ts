...
router.get('/ai/stats', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to get AI stats', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
...
router.get('/ai/segments', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to get user segments', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
...
router.get('/ai/patterns', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    res
      ...
      .json(ApiResponse.error('Failed to get behavior patterns', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
...
router.get('/ai/recommendations', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to get recommendations', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to store feedback', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
    }
  }
);
...
router.get('/status', authenticate, requireAdmin, (req, res) => {
  try {
    ...
    res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to get status', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
...
router.get('/activity', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    res
      .status(HTTP_STATUS.INTERNAL_SERVER_ERROR)
      .json(ApiResponse.error('Failed to retrieve activity feed', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
  }
});
  ...
  (req, res) => {
    try {
      ...
      if (success) {
        ...
        res.status(HTTP_STATUS.NOT_FOUND).json(ApiResponse.error('Alert not found', String(HTTP_STATUS.NOT_FOUND)));
      }
    } catch (error) {
      console.error('Acknowledge alert error:', error);
      res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to acknowledge alert', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
    }
  }
);
...
router.post(
  ...
  (req, res) => {
    try {
      ...
      res.status(HTTP_STATUS.INTERNAL_SERVER_ERROR).json(ApiResponse.error('Failed to resolve alert', String(HTTP_STATUS.INTERNAL_SERVER_ERROR)));
    }
  }
);
