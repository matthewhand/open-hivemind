...
router.get('/ai/stats', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to get AI stats', 500);
  }
});
...
router.get('/ai/segments', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to get user segments', 500);
  }
});
...
router.get('/ai/patterns', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to get behavior patterns', 500);
  }
});
...
router.get('/ai/recommendations', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to get recommendations', 500);
  }
});
...
router.post('/ai/feedback', authenticate, requireAdmin, async (req, res) => {
  ...
  try {
    ...
    ApiResponse.error(res, 'Failed to store feedback', 500);
  }
});
...
router.get('/activity', authenticate, requireAdmin, async (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to retrieve activity feed', 500);
  }
});
...
router.post('/alerts/:id/acknowledge', authenticate, requireAdmin, (req, res) => {
  try {
    ...
    if (success) {
      ...
      ApiResponse.error(res, 'Alert not found', 404, undefined, { message: 'Alert not found' });
    }
  } catch (error) {
    console.error('Acknowledge alert error:', error);
    ApiResponse.error(res, 'Failed to acknowledge alert', 500);
  }
});
...
router.post('/alerts/:id/resolve', authenticate, requireAdmin, (req, res) => {
  try {
    ...
    ApiResponse.error(res, 'Failed to resolve alert', 500);
  }
});
