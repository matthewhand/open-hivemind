...
const debug = Debug('app:webui:mcp:config');
const router = Router();
...
router.get('/:id', validateRequest(MCPProviderIdParamSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/', validateRequest(CreateMCPProviderSchema), async (req, res) => {
  try {
...
router.put('/:id', validateRequest(UpdateMCPProviderSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', validateRequest(MCPProviderIdParamSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/:id/start', validateRequest(MCPProviderIdParamSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/:id/stop', validateRequest(MCPProviderIdParamSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/:id/test', validateRequest(MCPProviderIdParamSchema), async (req, res) => {
  try {
    const { id } = req.params;
