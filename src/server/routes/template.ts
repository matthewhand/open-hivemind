...
const validateTemplateFilter = [
  ...
  query('isBuiltIn')
    .optional()
    .isBoolean()
    .withMessage('isBuiltIn filter must be a boolean'),
 ...
 */
router.get('/', authenticate, validateTemplateFilter, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
 ...
 */
router.get('/popular', authenticate, validateTemplateFilter, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
 ...
 */
router.get('/recent', authenticate, validateTemplateFilter, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const limit = req.query.limit ? parseInt(req.query.limit as string) : 10;
 ...
 */
router.get('/categories/:category', authenticate, validateTemplateFilter, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
 ...
 */
router.get('/:templateId', authenticate, validateTemplateId, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
 ...
 */
router.post('/', requireAdmin, validateTemplateCreation, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const authReq = req as any;
 ...
 */
router.put('/:templateId', requireAdmin, validateTemplateId, validateTemplateUpdate, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 * Delete a template
 */
router.delete('/:templateId', requireAdmin, validateTemplateId, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.post('/:templateId/duplicate', requireAdmin, validateTemplateId, validateTemplateDuplication, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.get('/:templateId/export', authenticate, validateTemplateId, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.post('/:templateId/use', authenticate, validateTemplateId, handleValidationErrors, async (req: AuthMiddlewareRequest, res: Response) => {
  try {
    const { templateId } = req.params;
