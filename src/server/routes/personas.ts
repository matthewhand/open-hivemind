...
router.get('/', (req, res) => {
  try {
    ...
    logger.error('Failed to retrieve personas', { errorMessage: error.message });
...
router.get('/:id', (req, res) => {
  try {
    ...
    logger.error('Failed to retrieve persona', { id: req.params.id, errorMessage: error.message });
