module.exports = {
    ...
    LLM_SUMMARY_SYSTEM_PROMPT: process.env.LLM_SUMMARY_SYSTEM_PROMPT || 'You take User input and generate a summarised output.  Assume the perspective of the speaker. ', // 'Summarise the message without losing the first person perspective (and only this): ',
