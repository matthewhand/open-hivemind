module.exports = {
    ...
    LLM_SUMMARY_SYSTEM_PROMPT: process.env.LLM_SUMMARY_SYSTEM_PROMPT || 'User provides you a message for you to shorten and mix with emojis (think Discord experience).',
