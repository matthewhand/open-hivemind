...
function loadMessageConfig(): MessageConfig {
  ...
  mapEnv(
    'MESSAGE_UNSOLICITED_REQUIRE_OPPORTUNITY',
    'MESSAGE_UNSOLICITED_REQUIRE_OPPORTUNITY',
    parseBool
  );
  ...
  mapEnv('MESSAGE_HISTORY_SUMMARY_ENABLED', 'MESSAGE_HISTORY_SUMMARY_ENABLED', parseBool);
  mapEnv('MESSAGE_HISTORY_SUMMARY_THRESHOLD', 'MESSAGE_HISTORY_SUMMARY_THRESHOLD', parseIntBase10);
  mapEnv(
    'MESSAGE_HISTORY_SUMMARY_KEEP_RECENT',
    'MESSAGE_HISTORY_SUMMARY_KEEP_RECENT',
    parseIntBase10
  );
  mapEnv(
    'MESSAGE_HISTORY_SUMMARY_MAX_WORDS',
    'MESSAGE_HISTORY_SUMMARY_MAX_WORDS',
    parseIntBase10
  );
