...
export const RESPONSE_PROFILE_KEY_TYPES: Record<ResponseProfileOverrideKey, 'number' | 'boolean'> = {
  ...
  MESSAGE_UNSOLICITED_USER_COUNT_PENALTY_PER_USER: 'number',
  MESSAGE_UNSOLICITED_BOT_RATIO_PENALTY: 'number',
  MESSAGE_UNSOLICITED_BOT_HISTORY_PENALTY_PER_MESSAGE: 'number',
  MESSAGE_UNSOLICITED_BURST_TRAFFIC_PENALTY_PER_MESSAGE: 'number',
};
