...
export const MessageSchema = z.object({
  ...
  MESSAGE_HISTORY_SUMMARY_ENABLED: z.boolean().default(false),
  MESSAGE_HISTORY_SUMMARY_THRESHOLD: z.number().int().default(20),
  MESSAGE_HISTORY_SUMMARY_KEEP_RECENT: z.number().int().default(10),
  MESSAGE_HISTORY_SUMMARY_MAX_WORDS: z.number().int().default(150),
