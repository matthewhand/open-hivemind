...
const llmConfig = 'llmConfig') as unknown as { LLM_PROVIDER: string; LLM_STOP?: string[]; LLM_SYSTEM_PROMPT?: string; LLM_RESPONSE_MAX_TOKENS?: number; LLM_INCLUDE_USERNAME_IN_CHAT_COMPLETION?: boolean };
