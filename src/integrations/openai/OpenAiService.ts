...
export class OpenAiService {
    ...
    private constructor() {
        ...
        this.finishReasonRetry = String(openaiConfig.get<'OPENAI_FINISH_REASON_RETRY'>('OPENAI_FINISH_REASON_RETRY') || 'stop');
        this.maxRetries = Number(openaiConfig.get<'OPENAI_MAX_RETRIES'>('OPENAI_MAX_RETRIES') || 3);
