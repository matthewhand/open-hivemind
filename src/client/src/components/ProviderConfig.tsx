...
import { CheckCircle, Eye, EyeOff, Info, Key, Lock, Settings, Shield } from 'lucide-react';
        ...
        return [
          {
            ...
            fields: [
              ...
              { key: 'channelId', label: 'Channel ID', helperText: 'Default text channel ID' },
              {
                ...
                helperText: 'Voice channel for audio features',
              },
            ],
          },
        ];
            ...
            fields: [
              {
                ...
                label: 'Bot Token',
                type: 'password',
                helperText: 'Bot token from Slack App settings',
              },
              {
                key: 'appToken',
                label: 'App Token',
                type: 'password',
                helperText: 'App-level token for Socket Mode',
              },
              {
                key: 'signingSecret',
        ...
        return [
          {
            ...
            fields: [
              ...
              },
              {
                key: 'baseUrl',
                label: 'Base URL',
                helperText: 'OpenAI API base URL',
        ...
        return [
          {
            ...
            fields: [
              ...
              },
              {
                key: 'chatflowId',
                label: 'Chatflow ID',
                helperText: 'Specific chatflow ID to use',
              },
            ],
          },
        ];
        ...
        return [
          {
            ...
            fields: [
              ...
              },
              {
                key: 'team',
                label: 'Team',
                helperText: 'Team name (used as model)',
