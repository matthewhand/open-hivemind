            ...
            <div className="flex items-center gap-2">
               <Tooltip content="Run Performance Benchmark" position="top">
                 <button
                   ...
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 hover:opacity-100 focus-visible:opacity-100 focus-within:opacity-100 transition-opacity text-warning"
               ...
               <Tooltip content="Version History" position="top">
                 <button
                   ...
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 hover:opacity-100 focus-visible:opacity-100 focus-within:opacity-100 transition-opacity text-secondary"
               ...
               <Tooltip content="AI Performance Insights" position="top">
                 <button
                   ...
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 hover:opacity-100 focus-visible:opacity-100 focus-within:opacity-100 transition-opacity text-primary"
               ...
               <Tooltip content="Run Diagnostic" position="top">
                 <button
                   ...
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 hover:opacity-100 focus-visible:opacity-100 focus-within:opacity-100 transition-opacity"
