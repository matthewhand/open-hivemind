            ...
            <div className="flex items-center gap-2">
               <Tooltip content="Run Performance Benchmark" position="top">
                 <Button
                   variant="ghost"
                   size="xs"
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 focus-within:opacity-100 group-focus-visible:opacity-100 hover:opacity-100 transition-opacity text-warning"
               ...
               <Tooltip content="Version History" position="top">
                 <Button
                   variant="ghost"
                   size="xs"
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 focus-within:opacity-100 group-focus-visible:opacity-100 hover:opacity-100 transition-opacity text-secondary"
               ...
               <Tooltip content="AI Performance Insights" position="top">
                 <Button
                   variant="ghost"
                   size="xs"
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 focus-within:opacity-100 group-focus-visible:opacity-100 hover:opacity-100 transition-opacity text-primary"
               ...
               <Tooltip content="Run Diagnostic" position="top">
                 <Button
                   variant="ghost"
                   size="xs"
                   className="btn btn-ghost btn-xs btn-square opacity-0 group-hover:opacity-40 focus-within:opacity-100 group-focus-visible:opacity-100 hover:opacity-100 transition-opacity"
