  ...
  return (
    <div className={`dropdown ${positionClasses[position]} ${className}`} ref={dropdownRef}>
      <button
        ...
        className={`btn ${sizeClasses[size]} ${colorClasses[color]} ${disabled ? 'btn-disabled opacity-50' : ''} focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none ${triggerClassName}`}
