    ...
    <nav className="navbar bg-base-100 shadow-lg border-b border-base-200 px-4" aria-label="Main navigation">
      ...
      <div className="navbar-start gap-2">
        ...
        <div className="dropdown lg:hidden">
          <button type="button" tabIndex={0} className="btn btn-ghost btn-circle" aria-label="Open mobile menu">
      ...
      <div className="navbar-end gap-1 sm:gap-3">
        ...
        */}
        ...
        <div className="dropdown dropdown-end">
          <button type="button" tabIndex={0} className="btn btn-ghost btn-circle btn-sm" aria-label="System status">
            <Indicator
        ...
        {/* User Menu */}
        <div className="dropdown dropdown-end">
          <button type="button" tabIndex={0} className="btn btn-ghost btn-circle avatar ml-1" aria-label="User menu">
