    ...
    <nav className="navbar bg-base-100 shadow-lg border-b border-base-200 px-4" aria-label="Main navigation">
      ...
      <div className="navbar-start gap-2">
        ...
        <div className="dropdown lg:hidden">
          <button type="button" aria-haspopup="menu" className="btn btn-ghost btn-circle" aria-label="Open mobile menu">
                    ...
                    {recentSearches.map((search, index) => (
                      <li key={index}>
                        ...
                        >
                          ...
                          <span className="text-[10px] opacity-0 focus-visible:opacity-40 group-hover:opacity-40 transition-opacity">Select ↵</span>
                        </button>
                      </li>
                    ))}
                  </ul>
      ...
      <div className="navbar-end gap-1 sm:gap-3">
        ...
        */}
        ...
        <div className="dropdown dropdown-end">
          <button type="button" aria-haspopup="menu" className="btn btn-ghost btn-circle btn-sm" aria-label="System status">
            <Indicator
        ...
        {/* Notifications */}
        <div className="dropdown dropdown-end">
          <button type="button" aria-haspopup="menu" className="btn btn-ghost btn-circle btn-sm" onClick={onNotificationClick} aria-label={`Notifications, ${notificationCount} unread`}>
            <Indicator
        ...
        {/* User Menu */}
        <div className="dropdown dropdown-end">
          <button type="button" aria-haspopup="menu" className="btn btn-ghost btn-circle avatar ml-1" aria-label="User menu">
