      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {actionLabel && onAction && (
          <Button
            variant={variant}
            onClick={onAction}
            className={`gap-2 shadow-lg transition-shadow ${styles.buttonShadow}`}
          >
            {actionLabel}
          </Button>
        )}
