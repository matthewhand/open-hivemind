            ...
            const innerContent = (
              <div className="card-body p-4 gap-2 text-left">
                ...
                {actions && actions.length > 0 && (
                  <div className="card-actions justify-end mt-2 pt-2 border-t border-base-200" onClick={e => e.stopPropagation()} onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.stopPropagation(); } }}>
