...
const ThemeDropdown: React.FC<ThemeDropdownProps> = ({ 
  ...
  if (!mounted) {
    return (
      <div className={dropdownClass}>
        <button type="button" aria-haspopup="menu" aria-expanded="false" className="btn btn-ghost btn-sm btn-circle focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none" aria-label="Theme menu">
  ...
  return (
    <div className={dropdownClass}>
      <button type="button" aria-haspopup="menu" aria-expanded="false" className="btn btn-ghost btn-sm gap-1 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none" aria-label="Theme switcher">
        <Palette className="w-4 h-4" />
