...
const ThemeDropdown: React.FC<ThemeDropdownProps> = ({ 
  ...
  if (!mounted) {
    return (
      <div className={dropdownClass}>
        <button type="button" className="btn btn-ghost btn-sm btn-circle" aria-label="Theme menu">
  ...
  return (
    <div className={dropdownClass}>
      <button type="button" className="btn btn-ghost btn-sm gap-1" aria-label="Theme switcher">
        <Palette className="w-4 h-4" />
