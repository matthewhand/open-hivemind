...
export const ModalDemo: React.FC<{ onOpenModal: () => void }> = ({ onOpenModal }) => {
  return (
    <div className="space-y-8">
      <Section title="Modal">
        <button className="btn btn-primary" onClick={onOpenModal}>Open Modal</button>
      </Section>
    </div>
  );
};
...
export const StatDemo: React.FC = () => {
  return (
    <div className="space-y-8">
