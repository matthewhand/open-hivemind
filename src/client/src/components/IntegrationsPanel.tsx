    ...
    return (
      <div className="mb-10">
        ...
        {llmProfiles.length === 0 ? (
          <section aria-labelledby="empty-integrations-heading" className="text-center py-8 opacity-50 border-2 border-dashed border-base-200 rounded-xl mb-6">
            <h3 id="empty-integrations-heading" className="sr-only">No custom LLM profiles configured</h3>
