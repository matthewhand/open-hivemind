  ...
  return (
    <div className="flex-1 space-y-6">
      ...
      <PageHeader
        ...
        description={`Real-time system status and metrics. Last updated: ${lastRefresh.toLocaleTimeString()}`}
        icon={Activity}
        actions={
          <Button
            variant="ghost"
      ...
      <div className="tabs tabs-boxed bg-base-200 p-1">
        {tabs.map((tab, index) => (
          <a
            key={index}
            role="tab"
            className={`tab gap-2 transition-all duration-200 ${activeTab === index ? 'tab-active bg-primary text-primary-content shadow-sm' : 'hover:bg-base-300'}`}
      ...
      {/* Tab Content */}
      <div className="bg-base-100 rounded-xl border border-base-200 shadow-sm min-h-[400px]">
