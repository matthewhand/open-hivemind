...
describe('DashboardBotCard A11y', () => {
  ...
  it('renders Action buttons with focus visibility classes', () => {
    ...
    expect(runBenchmarkBtn).toHaveClass('group-focus-visible:opacity-100');
    ...
    expect(viewHistoryBtn).toHaveClass('group-focus-visible:opacity-100');
    ...
    expect(insightsBtn).toHaveClass('group-focus-visible:opacity-100');
    ...
    expect(diagnosticBtn).toHaveClass('group-focus-visible:opacity-100');
