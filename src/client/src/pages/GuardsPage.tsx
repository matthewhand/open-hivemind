          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="collapse collapse-arrow bg-base-200">
              ...
              <div className="collapse-content bg-base-100 pt-4">
                ...
                {editingProfile.guards.mcpGuard.type === 'custom' && (
                  <div className={`form-control mt-4 transition-all duration-200 ${!editingProfile.guards.mcpGuard.enabled ? 'opacity-50 pointer-events-none' : ''}`} aria-disabled={!editingProfile.guards.mcpGuard.enabled}>
                    <Input
                      id="allowed-users"
                      type="text"
            ...
            <div className="collapse collapse-arrow bg-base-200">
              ...
              <div className="collapse-content bg-base-100 pt-4">
                ...
                <div className={`form-control mt-4 transition-all duration-200 ${!editingProfile.guards.contentFilter?.enabled ? 'opacity-50 pointer-events-none' : ''}`} aria-disabled={!editingProfile.guards.contentFilter?.enabled}>
