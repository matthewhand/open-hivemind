  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {loading && !editingProfile ? (
        ...
        <EmptyState
          icon={Shield}
          title={searchValue ? "No matching profiles" : "No Guard Profiles"}
          description={searchValue ? "Try adjusting your search terms" : "Create a guard profile to enforce security policies and access controls for your bots."}
          actionLabel={searchValue ? undefined : "New Profile"}
          actionIcon={searchValue ? undefined : Plus}
          onAction={searchValue ? undefined : handleCreate}
