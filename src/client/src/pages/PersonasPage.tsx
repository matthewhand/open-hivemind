...
const PersonasPage: React.FC = () => {
  ...
  const openViewModal = (persona: Persona) => {
    ...
    setCloningPersonaId(null);
    setIsViewOnly(true);
    setShowEditModal(true); // Reuse edit modal
  };
  ...
  return (
    <div className="space-y-6">
                ...
                {persona.assignedBotNames.length > 0 ? (
                  <div className="flex flex-wrap gap-1">
                    ...
                    {persona.assignedBotNames.length > 3 && (
                      <Badge variant="neutral" size="small" style="outline" className="opacity-70">
      ...
      <Modal
        ...
        onClose={() => { setShowCreateModal(false); setShowEditModal(false); setIsViewOnly(false); }}
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2 mt-6">
            <Button variant="ghost" onClick={() => { setShowCreateModal(false); setShowEditModal(false); setIsViewOnly(false); }}>{isViewOnly ? 'Close' : 'Cancel'}</Button>
            {!isViewOnly && (
