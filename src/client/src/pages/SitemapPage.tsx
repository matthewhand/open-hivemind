...
const SitemapPage: React.FC = () => {
  ...
  const groupedUrls = sitemapData?.urls.reduce((acc, url) => {
    ...
    if (url.url === '/') {
      ...
      if (url.url.includes('/ai/')) { category = 'AI Features'; }
      else if (url.url.includes('/bots')) { category = 'Bot Management'; }
      else if (url.url.includes('/mcp')) { category = 'MCP Servers'; }
      else if (url.url.includes('/integrations')) { category = 'Integrations'; }
      else if (url.url.includes('/monitoring') || url.url.includes('/activity') || url.url.includes('/analytics')) { category = 'Monitoring & Analytics'; }
      ...
      else if (url.url.includes('/specs')) { category = 'Specs'; }
