    ...
    <div className="p-6">
      ...
      {servers.length === 0 ? (
        <EmptyState
          ...
          description="Get started by adding your first Model Context Protocol server."
        ...
        <EmptyState
          ...
          description={`No servers match your search for "${searchQuery}" with status "${statusFilter}"`}
