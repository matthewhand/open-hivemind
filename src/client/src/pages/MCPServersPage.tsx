    ...
    <div className="p-6">
      ...
      {servers.length === 0 ? (
        <EmptyState
          ...
          description="Connect Model Context Protocol servers to extend your agents with external tools and data sources."
        ...
        <EmptyState
          ...
          description={`No servers matching "${searchTerm}" found with the selected filters.`}
