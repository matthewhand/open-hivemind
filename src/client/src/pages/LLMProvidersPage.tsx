...
import { Card, Button, Badge, Alert, PageHeader, StatsCards, EmptyState, LoadingSpinner, Tooltip } from '../components/DaisyUI';
...
const LLMProvidersPage: React.FC = () => {
  ...
  const renderLibraryCheck = (type: string) => {
    ...
    if (!status.installed) {
      return (
        <Tooltip position="bottom" content={`Missing required library: ${status.package}`}>
