            ...
            filters={[
              {
                ...
                options: platforms.map(p => ({ label: p === 'All' ? 'All Platforms' : p.charAt(0).toUpperCase() + p.slice(1), value: p })),
              ...
              },
              {
                ...
                options: personas.map(p => ({ label: p === 'All' ? 'All Personas' : p, value: p })),
                className: 'w-full sm:w-48'
              },
              {
                key: 'llmProvider',
                ...
                options: llmProviders.map(p => ({ label: p === 'All' ? 'All Providers' : p, value: p })),
                className: 'w-full sm:w-48'
              }
            ]}
            onClear={() => {
