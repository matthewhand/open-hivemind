            ...
            suffix={
              searchQuery && (
                <button
                  ...
                  className="btn btn-ghost btn-xs rounded-full h-6 min-h-0 w-6 p-0"
                >
                   ×
                </button>
              )
          ...
          {loading && bots.length === 0 ? (
            ...
            <div className="text-center py-12">
             ...
             <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-base-content/60">No bots found matching your search</h3>
              <p className="text-base-content/50 mb-4">Try adjusting your search terms</p>
