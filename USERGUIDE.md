...
*   **Bot Details & Activity**: View detailed configuration and real-time activity logs for a specific bot.
![Bot Details Activity](docs/images/bot-details-activity.png)
