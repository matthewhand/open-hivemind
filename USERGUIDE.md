...
*   **View Modes**: Toggle between a visual card grid and a detailed list view.
*   **Search & Filter**: Quickly find pages by path or description, and filter by access level.
