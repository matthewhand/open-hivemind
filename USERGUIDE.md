...
![Bot Templates](docs/screenshots/bot-templates-list.png)
...
*   **Filtering**: Find templates by platform, name, or tags.
...
*   **Content Filtering**: Enforce strictness levels for bot outputs.
