...
*   **Manage Tools**: View and enable/disable specific tools provided by connected servers.
*   **Connection Status**: Monitor the health and connection status of your MCP servers.
