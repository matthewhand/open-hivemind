...
*   **Tool Execution**: Test tools directly using an interactive form or raw JSON.
    *   **Form Mode**: Automatically generated form fields based on the tool's input schema.
    *   **JSON Mode**: Advanced mode for complex inputs or raw JSON editing.
