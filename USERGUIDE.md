...
*   **View Details**: Quickly inspect the full system prompt and assigned bots without entering edit mode.
*   **Assigned Bots**: See which bots are using each persona at a glance.
