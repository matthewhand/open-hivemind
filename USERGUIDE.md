...
*   **Tool Execution**: Test tools using an auto-generated form or raw JSON arguments.
    *   **Form Mode**: Fill out tool arguments using a user-friendly form based on the tool's schema.
    *   **JSON Mode**: For advanced usage, switch to JSON mode to edit raw arguments.

    ![MCP Tool Run Modal](docs/screenshots/mcp-tools-run-modal.png)
