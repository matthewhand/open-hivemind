...
*   **System Health**: Real-time metrics for CPU, Memory, Uptime, and load averages.
*   **Bot Status**: Detailed status cards for each bot showing connectivity, response times, and error rates.
*   **Activity Monitor**: Live feed of incoming and outgoing messages with filtering capabilities.
*   **Health Checks**: Status of internal API endpoints and services.
