...
*   **Tool Execution**: Test tools directly. The interface provides a **Form Builder** to easily fill in arguments based on the tool's schema, with a toggle to switch to raw JSON mode for advanced usage.
