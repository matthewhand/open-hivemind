...
describe('BotConfigRepositoryBase', () => {
  ...
  beforeAll(() => {
    ...
    require('../../../src/database/EncryptionService').encryptionService.encryptionKey = Buffer.from('12345678901234567890123456789012');
  });
  ...
  describe('decryptField', () => {
    it('should return non-string values as-is', () => {
      expect((base as any).decryptField(123)).toBe(123);
