const unitIntegrationProject = {
  ...
  moduleNameMapper: {
    ...
    '^@src/integrations/discord/(.*)$': '<rootDir>/packages/adapter-discord/src/$1',
    '^@src/integrations/mattermost/(.*)$': '<rootDir>/packages/adapter-mattermost/src/$1',
    '^@src/integrations/flowise/(.*)$': '<rootDir>/packages/provider-flowise/src/$1',
    '^@src/integrations/openai/(.*)$': '<rootDir>/packages/provider-openai/src/$1',
    '^@src/integrations/openswarm/(.*)$': '<rootDir>/packages/provider-openswarm/src/$1',
    '^@src/integrations/openwebui/(.*)$': '<rootDir>/packages/provider-openwebui/src/$1',
    '^@src/(.*)$': '<rootDir>/src/$1',
