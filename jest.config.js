const unitIntegrationProject = {
  ...
  moduleNameMapper: {
    ...
    '^@hivemind/provider-flowise$': '<rootDir>/packages/provider-flowise/src/index.ts',
    '^@hivemind/provider-flowise/(.*)$': '<rootDir>/packages/provider-flowise/src/$1',
    ...
    '^@hivemind/provider-openswarm$': '<rootDir>/packages/provider-openswarm/src/index.ts',
    '^@hivemind/provider-openswarm/(.*)$': '<rootDir>/packages/provider-openswarm/src/$1',
    '^@hivemind/provider-openwebui$': '<rootDir>/packages/provider-openwebui/src/index.ts',
    '^@hivemind/provider-openwebui/(.*)$': '<rootDir>/packages/provider-openwebui/src/$1',
