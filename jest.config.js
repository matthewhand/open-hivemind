module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@src/integrations/discord/(.*)$': '<rootDir>/packages/message-discord/src/$1',
    ...
    '^@src/integrations/flowise/(.*)$': '<rootDir>/packages/llm-flowise/src/$1',
    '^@src/integrations/letta/(.*)$': '<rootDir>/packages/llm-letta/src/$1',
    '^@src/integrations/openai/(.*)$': '<rootDir>/packages/llm-openai/src/$1',
    '^@src/integrations/openswarm/(.*)$': '<rootDir>/packages/llm-openswarm/src/$1',
    '^@src/integrations/openwebui/(.*)$': '<rootDir>/packages/llm-openwebui/src/$1',
    '^@src/integrations/mem0/(.*)$': '<rootDir>/packages/memory-mem0/src/$1',
    '^@src/integrations/mem4ai/(.*)$': '<rootDir>/packages/memory-mem4ai/src/$1',
    '^@src/integrations/mcp/(.*)$': '<rootDir>/packages/tool-mcp/src/$1',
    ...
    '^@integrations/mattermost/(.*)$': '<rootDir>/packages/message-mattermost/src/$1',
    '^@integrations/flowise/(.*)$': '<rootDir>/packages/llm-flowise/src/$1',
    '^@integrations/letta/(.*)$': '<rootDir>/packages/llm-letta/src/$1',
    '^@integrations/openai/(.*)$': '<rootDir>/packages/llm-openai/src/$1',
    '^@integrations/openswarm/(.*)$': '<rootDir>/packages/llm-openswarm/src/$1',
    '^@integrations/openwebui/(.*)$': '<rootDir>/packages/llm-openwebui/src/$1',
    '^@integrations/mem0/(.*)$': '<rootDir>/packages/memory-mem0/src/$1',
    '^@integrations/mem4ai/(.*)$': '<rootDir>/packages/memory-mem4ai/src/$1',
    '^@integrations/mcp/(.*)$': '<rootDir>/packages/tool-mcp/src/$1',
