...
export const Form: React.FC<FormProps> = ({
  ...
  const handleInputChange = (fieldName: string, value: any) => {
    ...
    if (validateOnChange) {
      ...
      if (field) {
        ...
        // Mark the field as touched when validating on change
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Mark all fields as touched and validate them together
  ...
  return (
    <form
      ...
      action={action}
      encType={encType}
      noValidate={true} // Always use noValidate to prevent browser validation
      role="form"
      aria-label={ariaLabel}
      aria-labelledby={ariaLabelledBy}
      aria-describedby={ariaDescribedBy}
