        ...
        <div className="space-y-4">
          <div className="form-control">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateFormData('botName', e.target.value)}
            />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="form-control">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateFormData('token', e.target.value)}
            />
          </div>
        </div>
      ),
