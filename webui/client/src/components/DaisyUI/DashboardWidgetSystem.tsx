...
// Widget Components
const StatsWidget: React.FC<WidgetProps> = ({ widget, isEditing, onRemove, onConfigure }) => {
...
const ChartWidget: React.FC<WidgetProps> = ({ widget, isEditing, onRemove, onConfigure }) => {
...
const ActivityWidget: React.FC<WidgetProps> = ({ widget, isEditing, onRemove, onConfigure }) => {
...
const QuickActionsWidget: React.FC<WidgetProps> = ({ widget, isEditing, onRemove, onConfigure }) => {
...
const SystemHealthWidget: React.FC<WidgetProps> = ({ widget, isEditing, onRemove, onConfigure }) => {
              ...
              <div className="flex-1">
                <progress
                  className={`progress w-full ${
                    numValue > 80 ? 'progress-error' :
                    numValue > 60 ? 'progress-warning' : 'progress-success'
                  }`}
                  value={numValue}
                  max="100"
                />
              </div>
              <div className="w-12 text-sm text-right">{numValue}%</div>
            </div>
          );
        })}
      </div>
