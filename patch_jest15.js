...
const regex = /'\^@hivemind\/llm-letta\/\(\.\*\)\$': '<rootDir>\/packages\/llm-letta\/src\/\$1',/g;
const replacement = `'^@hivemind/llm-letta/(.*)$$': '<rootDir>/packages/llm-letta/src/$$1',
...
configStr = configStr.replace(regex, replacement);
