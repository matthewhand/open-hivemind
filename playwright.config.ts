...
export default defineConfig({
  ...
  webServer: {
    command: 'export NODE_OPTIONS="--max-old-space-size=4096"; export DISABLE_RATE_LIMIT=true; export ALLOW_LOCALHOST_ADMIN=true; export OPENAI_API_KEY="sk-test"; npm run dev',
