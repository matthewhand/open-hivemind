...
export const slackConfigData: ConfigTestData = {
  defaults: {
    ...
    WELCOME_RESOURCE_URL: 'https://example.com/resources',
...
export const discordConfigGenerator = fc.record({
  ...
  DISCORD_UNSOLICITED_CHANCE_MODIFIER: fc.float({
    min: Math.fround(0.1),
    max: Math.fround(2.0),
    noNaN: true,
  }),
  ...
  DISCORD_PRIORITY_CHANNEL_BONUS: fc.float({
    min: Math.fround(0.1),
    max: Math.fround(2.0),
    noNaN: true,
  }),
...
export const messageConfigGenerator = fc.record({
  ...
  MESSAGE_RECENT_ACTIVITY_DECAY_RATE: fc.float({
    min: Math.fround(0.1),
    max: Math.fround(1.0),
    noNaN: true,
  }),
  MESSAGE_INTERROBANG_BONUS: fc.float({
    min: Math.fround(0.1),
    max: Math.fround(2.0),
    noNaN: true,
  }),
  MESSAGE_BOT_RESPONSE_MODIFIER: fc.float({
    min: Math.fround(-1.0),
    max: Math.fround(1.0),
    noNaN: true,
  }),
  ...
  MESSAGE_SEMANTIC_RELEVANCE_BONUS: fc.float({
    min: Math.fround(0.1),
