...
describe('[ChannelRouter] parsing and scoring', () => {
  ...
  test('should parse bonuses and priorities correctly', () => {
    // CSV parsing
  ...
  test('should compute scores and handle invalid values', () => {
    ...
    // invalid out-of-range bonuses and non-integer priorities
  ...
  test('should pick best channel correctly', () => {
    // pickBestChannel chooses highest score with tie-breakers
    ...
    // equal scores and equal bonuses, lexicographic tiebreaker
