...
describe('GreetingStateManager', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should handle missing state file (ENOENT) gracefully', async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('No existing greeting state file found, starting fresh');
    });
    ...
    it('should handle other file read errors by starting with empty state and logging error', async () => {
      ...
      expect(manager.getAllState()).toEqual({});
      expect(mockLogger.error).toHaveBeenCalledWith('Failed to initialize GreetingStateManager', { error });
    });
  ...
  describe('State Operations', () => {
    ...
    describe('markGreetingAsSent', () => {
        ...
        it('should propagate save errors', async () => {
            ...
            await expect(manager.markGreetingAsSent('service-fail', 'chan-fail')).rejects.toThrow('Write failed');
