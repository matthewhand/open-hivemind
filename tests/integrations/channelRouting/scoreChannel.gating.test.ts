...
async function loadServices() {
  const dMod: any = await import('@hivemind/message-discord');
  const sMod: any = await import('@hivemind/message-slack');
  const mMod: any = await import('@hivemind/message-mattermost');
