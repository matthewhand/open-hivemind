...
describe('openwebui/uploadKnowledgeFile', () => {
  ...
  const loadIsolated = (opts?: {
    ...
    jest.doMock('@hivemind/llm-openwebui/openWebUIConfig', () => ({
      __esModule: true,
      default: {
        getProperties: () => ({
    ...
    jest.doMock('@hivemind/llm-openwebui/sessionManager', () => ({
      __esModule: true,
    ...
    let mod: any;
    jest.isolateModules(() => {
      mod = require('@hivemind/llm-openwebui/uploadKnowledgeFile');
    });
