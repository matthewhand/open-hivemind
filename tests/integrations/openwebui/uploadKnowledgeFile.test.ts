...
describe('openwebui/uploadKnowledgeFile', () => {
  ...
  const loadIsolated = (opts?: {
    ...
    jest.doMock('../../../packages/llm-openwebui/src/openWebUIConfig', () => ({
      __esModule: true,
      default: {
        getProperties: () => ({
    ...
    jest.doMock('../../../packages/llm-openwebui/src/sessionManager', () => ({
      __esModule: true,
    ...
    let mod: any;
    jest.isolateModules(() => {
      mod = require('../../../packages/llm-openwebui/src/uploadKnowledgeFile');
    });
