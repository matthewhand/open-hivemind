...
export const Discord = {
  ...
  DiscordService: class extends EventEmitter implements IMessengerService {
    ...
    public constructor() {
      super();
      this.botManager = new DiscordBotManager();
      this.messageSender = new DiscordMessageSender(this.botManager);
      this.eventHandler = new DiscordEventHandler(this.botManager, (channelId) =>
