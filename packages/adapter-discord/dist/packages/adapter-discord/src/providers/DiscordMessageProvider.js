...
exports.DiscordMessageProvider = void 0;
...
class DiscordMessageProvider {
    constructor() {
        this.discordSvc = DiscordService_1.Discord.DiscordService.getInstance();
    }
    /**
...
exports.DiscordMessageProvider = DiscordMessageProvider;
