...
convict_1.default.addFormat({
    ...
    coerce: (val) => {
        ...
        // Parse CSV format
        return val.split(',').reduce((acc, kvp) => {
...
const discordConfig = (0, convict_1.default)({
    DISCORD_BOT_TOKEN: {
...
const debug = (0, debug_1.default)('app:discordConfig');
const configDir = process.env.NODE_CONFIG_DIR || path_1.default.join(__dirname, '../../config');
const configPath = path_1.default.join(configDir, 'providers/discord.json');
try {
