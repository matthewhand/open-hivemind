...
export interface IConfigErrorConstructor {
    ...
    (message: string, configKey?: string, expectedType?: string, providedType?: string, context?: unknown): IBaseError;
    prototype: Error;
}
...
export interface IValidationErrorConstructor {
    ...
    (message: string, details?: unknown, value?: unknown, expected?: unknown, suggestions?: unknown, context?: unknown): IBaseError;
    prototype: Error;
}
